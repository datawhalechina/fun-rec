...
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/2021-02-22-10-11-15.png" style="zoom: 50%;" />
</div>

这样庞大的参数量也是不实际的。为了解决DNN参数量过大的局限性，可以采用非常经典的Field思想，将OneHot特征转换为Dense Vector
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/2021-02-22-10-11-40.png" style="zoom: 50%;" />
</div>

此时通过增加全连接层就可以实现高阶的特征组合，如下图所示：
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/2021-02-22-10-11-59.png" style="zoom:67%;" />
</div>
...
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/2021-02-22-10-12-19.png" style="zoom:50%;" />
</div>
...
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/Javaimage-20200910214310877.png" alt="image-20200910214310877" style="zoom:60%;" />
</div>
...
## 模型的结构与原理
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/image-20210225180556628.png" alt="image-20210225180556628" style="zoom:80%;" />
</div>
...
$$
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/image-20210225181340313.png" alt="image-20210225181340313" style="zoom: 70%;" />
</div>
### Deep
Deep架构图
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/image-20210225181010107.png" alt="image-20210225181010107" style="zoom:70%;" />
</div>
...
<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/image-20210228161135777.png" alt="image-20210228161135777"  style="zoom:70%;"/>
</div>

下面是一个通过keras画的模型结构图，为了更好的显示，数值特征和类别特征都只是选择了一小部分，画图的代码也在github中。

<div align=center>
<img src="../../../imgs/ch02/ch2.2/ch2.2.3/DeepFM/DeepFM.png" alt="image-20210225180556628" style="zoom:30%;" />
</div>

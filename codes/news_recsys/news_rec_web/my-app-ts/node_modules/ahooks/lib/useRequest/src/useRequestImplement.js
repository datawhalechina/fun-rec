...
function useRequestImplement(service, options, plugins) {
  ...
  var serviceRef = index_1.useLatest(service);
  var update = index_1.useUpdate();
  ...
  return {
    ...
    cancel: index_1.useMemoizedFn(fetchInstance.cancel.bind(fetchInstance)),
    refresh: index_1.useMemoizedFn(fetchInstance.refresh.bind(fetchInstance)),
    refreshAsync: index_1.useMemoizedFn(fetchInstance.refreshAsync.bind(fetchInstance)),
    run: index_1.useMemoizedFn(fetchInstance.run.bind(fetchInstance)),
    runAsync: index_1.useMemoizedFn(fetchInstance.runAsync.bind(fetchInstance)),
    mutate: index_1.useMemoizedFn(fetchInstance.mutate.bind(fetchInstance))
  };
}

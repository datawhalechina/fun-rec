...
var useAntdTable = function useAntdTable(service, options) {
  ...
  var result = __1.usePagination(service, __assign({
    manual: true
  }, rest));
  ...
  return __assign(__assign({}, result), {
    tableProps: {
      ...
      onChange: __1.useMemoizedFn(onTableChange),
      pagination: {
    ...
    search: {
      submit: __1.useMemoizedFn(submit),
      type: type,
      changeType: __1.useMemoizedFn(changeType),
      reset: __1.useMemoizedFn(reset)
    }
  });
};

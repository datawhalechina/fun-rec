...
使用方式:
    from funrec.config.config_dien import CONFIG
    config = CONFIG
"""
...
CONFIG: Dict[str, Any] = {
    ...
    "training": {
        "build_function": "funrec.models.dien.build_dien_model",
        "model_params": {
            "dnn_units": [
                200,
                80,
            ...
            "interest_hidden_units": 64,
            "evolution_type": "AUGRU",

...
使用方式:
    from funrec.config.config_pepnet import CONFIG
    config = CONFIG
"""
...
CONFIG: Dict[str, Any] = {
    ...
    "training": {
        "build_function": "funrec.models.pepnet.build_pepnet_model",
        "model_params": {
            "task_names": [
                "is_click",
                "long_view",
...
# 为了向后兼容，也提供原始变量名
PEPNET_CONFIG = CONFIG


__all__ = ["CONFIG", "PEPNET_CONFIG"]
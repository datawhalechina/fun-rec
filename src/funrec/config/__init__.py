...
from .config_esmm import CONFIG as ESMM_CONFIG
...
# 导出所有配置
__all__ = ["load_config", "get_config", "Config", "CONFIG_MAPPING"] + ["AFM_CONFIG", "APG_CONFIG", "AUTOINT_CONFIG", "BIASSVD_CONFIG", "DCN_CONFIG", "DEEPFM_CONFIG", "DIEN_CONFIG", "DIN_CONFIG", "DSIN_CONFIG", "DSSM_CONFIG", "EGES_CONFIG", "ESMM_CONFIG", "FIBINET_CONFIG", "FM_CONFIG", "FM_RECALL_CONFIG", "FUNKSVD_CONFIG", "HMOE_CONFIG", "HSTU_CONFIG", "ITEM2VEC_CONFIG", "ITEM_CF_CONFIG", "M2M_CONFIG", "MIND_CONFIG", "MMOE_CONFIG", "NFM_CONFIG", "PEPNET_CONFIG", "PLE_CONFIG", "PNN_CONFIG", "PRM_CONFIG", "PRS_CONFIG", "SASREC_CONFIG", "SDM_CONFIG", "SHARED_BOTTOM_CONFIG", "STAR_CONFIG", "SWING_CONFIG", "USER_CF_CONFIG", "WIDE_DEEP_CONFIG", "XDEEPFM_CONFIG", "YOUTUBEDNN_CONFIG"]